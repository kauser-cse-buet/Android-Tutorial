...
public class DrinkCategoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView drinkListView = (ListView) findViewById(R.id.drink_list);
        ...
        AdapterView.OnItemClickListener myListener = new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(parent.getContext(), DrinkActivity.class);
                intent.putExtra(DrinkActivity.EXTRA_DRINKID, position);
                startActivity(intent);
            }
        };

        drinkListView.setOnItemClickListener(myListener);
    }
